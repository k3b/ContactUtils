...
public class ContactData
{
    ...
    public class OrganisationDetail  extends PreferredDetail {
        ...
        public OrganisationDetail(String organisation, int type, boolean is_preferred, String extra) {
    ...
    protected Map< String, OrganisationDetail > _organisations = null;
    protected Map< String, NumberDetail> _numbers = null;
    protected Map< String, EmailDetail> _emails = null;
    protected Map< String, AddressDetail> _addresses = null;
        ...
        boolean is_preferred )
    {
        ...
        if( _organisations == null )
            _organisations = new HashMap< String, OrganisationDetail>();
        ...
        boolean is_preferred )
    {
        ...
        if( _numbers == null )
            _numbers = new HashMap< String, NumberDetail>();
    ...
    protected void addEmail( String email, int type, boolean is_preferred )
    {
        ...
        if( _emails == null )
            _emails = new HashMap< String, EmailDetail>();
    ...
    protected void addAddress( String address, int type )
    {
        ...
        if( _addresses == null ) _addresses =
            new HashMap< String, AddressDetail>();
